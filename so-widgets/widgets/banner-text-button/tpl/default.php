    ...
    <div class="container" style="padding-bottom:0;">
        <div class="container" style="padding-bottom:0; text-align:<?php echo $instance['banner-text-align']; ?>">
            ...
            <div style="margin-top:20px; margin-bottom:16px;">
                <a href="<?php echo $instance['banner-text-button-button-link'];?>" style="font-weight: 500; background-color: #fff; color: #000; padding: 9px 30px; text-decoration:none;" class="hvr-float banner-text-button-hover">
