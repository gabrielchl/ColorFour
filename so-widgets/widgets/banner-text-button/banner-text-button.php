<?php
/*
Widget Name: Banner Text Button
Description: A banner with some text and a button.
Author: Gabriel Chi Hong Lee
*/

class Banner_Text_Button extends SiteOrigin_Widget {
    ...
    parent::__construct(
        ...
        __('Banner Text Button', 'hello-world-widget-text-domain'),

        // The $widget_options array, which is passed through to WP_Widget.
        // It has a couple of extras like the optional help URL, which should link to your sites help or support page.
        array(
            'description' => __('A banner with some text and a button.', 'hello-world-widget-text-domain'),
            'help'        => '',
        ),
        ...
        array(
            'banner-text-button-text-one' => array(
                'type' => 'text',
                'label' => __('Title text', 'section-title-bundle'),
                'default' => 'Text Here'
            ),
            'banner-text-button-text-two' => array(
                'type' => 'text',
                'label' => __('Content text', 'section-title-bundle'),
                'default' => 'Text Here'
            ),
            'banner-text-button-button-link' => array(
                'type' => 'text',
                'label' => __('Button link', 'section-title-bundle'),
                'default' => 'http://www.google.com/'
            ),
            'banner-text-button-button-text' => array(
                'type' => 'text',
...
siteorigin_widget_register('banner-text-button', __FILE__, 'Banner_Text_Button');

function banner_text_button_banner_img_src( $banner_url, $widget_meta ) {
    if( $widget_meta['ID'] == 'banner-text-btton') {
        $banner_url = plugin_dir_url(__FILE__) . 'banner_text_button_banner.png';
    }
    return $banner_url;
}
add_filter( 'siteorigin_widgets_widget_banner', 'banner_text_button_banner_img_src', 10, 2);